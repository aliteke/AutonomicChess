...
for bayesian bot detector make sure to additionally install pgmpy and daft
For a very simple demonstration of the technical basis for the proposed bayesian bot detector run the following command:
python .\testBayes.py